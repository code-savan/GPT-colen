...
const LandingPage = () => {
  ...
  return (
    <div className="w-full h-screen bg-gradient-to-br from-green-200  to-blue-200 land flex items-center justify-center md:block">
      ...
      <div>
        <div className="w-full text-center">
          <img
            src={assets.logo}
            alt="logo"
            className="w-28 mx-auto md:hidden"
          />
          ...
          <p className=" text-slate-600 font-poppins font-normal text-[18px] mt-4 w-[60%] mx-auto hidden md:block">
            ...
            Expertise in Natural Language Processing and Dialogue Generation.
            Join us as we revolutionize communication through AI Innovations.
          </p>
